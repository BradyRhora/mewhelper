/*
  ...
  - You are about to drop the column `imagePath` on the `Cat` table. All the data in the column will be lost.
...
INSERT INTO "new_Cat" ("cha", "con", "dex", "gender", "id", "int", "luk", "name", "parent1Id", "parent2Id", "retired", "sexuality", "spd", "str", "userId") SELECT "cha", "con", "dex", "gender", "id", "int", "luk", "name", "parent1Id", "parent2Id", "retired", "sexuality", "spd", "str", "userId" FROM "Cat";
DROP TABLE "Cat";
